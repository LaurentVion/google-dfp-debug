...
public class CreateAudienceSegments {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!params.parseArguments(args)) {
            ...
            params.customTargetingKeyId = 66L;//Long.parseLong("INSERT_CUSTOM_TARGETING_KEY_ID_HERE");
            params.customTargetingValueId = 67L;//Long.parseLong("INSERT_CUSTOM_TARGETING_VALUE_ID_HERE");
        }
